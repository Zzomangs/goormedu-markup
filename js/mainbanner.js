$(function(){
	...
	function move(n){
	  ...
	  let currentEl = $(".main-banner img").eq(current);
	  let nextEl = $(".main-banner img").eq(n); 
  
	  currentEl.css({left:"0px"}).animate({left:"-1375px"})
	  nextEl.css({left:"1375px"}).animate({left:"0px"})
